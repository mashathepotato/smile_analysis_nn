...
ROOT_DIR = "C:/Users/realc/OneDrive/Documents/IoM/Code"
...
# Path to trained weights file ????sd?fs
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        self.add_class("object", 1, "Teeth")

     
        # Train or validation dataset?
        assert subset in ["train", "val"]
        # wkhlhoifwijOIOIJLAJFSLD
        ...
        annotations1 = json.load(open('dataset/segmentation/train/train_tooth_segmentation.json'))
        # print(annotations1)
...
def train(model):
    ...
    # dataset_train.load_custom("dataset/segmentation", "train")
    dataset_train.load_custom("C:/Users/realc/OneDrive/Documents/IoM/Code/dataset/segmentation", "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = CustomDataset()
    # dataset_val.load_custom("dataset/segmentation", "val")
    dataset_train.load_custom("C:/Users/realc/OneDrive/Documents/IoM/Code/dataset/segmentation", "train")
    dataset_val.prepare()
